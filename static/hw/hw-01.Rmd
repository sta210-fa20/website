...
1. We will use the variables `calories` and `carb` for this analysis. What are the response and predictor variables? 
...
1. Based on the confidence interval, does knowing the number of calories help us understand the amount of carbohydrates in Starbucks food items? Briefly explain why or why not. 
...
Rank each of the following principles from  [Elements and Principles for Characterizing Variation between Data Analyses](https://arxiv.org/pdf/1903.07639.pdf)for data analysis from 1 to 5. Include a 1 - 2 sentence summary for each principle.  
