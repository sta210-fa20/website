...
ggplot(data = rs_pop, aes(x = x)) +
  geom_density(binwidth = 2, fill = "skyblue", color = "darkblue") +
...
.question[
Does the data provide sufficient evidence that the mean price per guest per night in Airbnbs in Asheville is different from $80? 
]
...
### We know the mean price per guest per night is not equal to 80, but what is a plausible estimate for the mean? 
