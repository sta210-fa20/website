...
1) Choose the functional form of $f$, i.e. .vocab[choose the appropriate model given the data]

- Suppose $f$ is a linear model
    $$\hat{y} = f(\mathbf{X}) = \beta_0 + \beta_1 x_1 + \dots + \beta_p x_p$$
