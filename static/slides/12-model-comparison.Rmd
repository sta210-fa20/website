...
## [Click here for PDF of slides](12-comparing-models.pdf)
...
**Recall**: $\purple{R^2}$ is the proportion of the variation in the response variable explained by the regression model
...
.vocab[Adjusted $R^2$]: measure that includes a penalty for unnecessary predictor variables
...
.question[
Which model would we choose based on $R^2$? Based on $Adj. R^2$?
]
...
.question[
Which model would we choose based on AIC? Based on BIC?
]
