---
title: "AE 16: Response to Leukemia Treatment"
...
1. Fit a model using `Age` to predict whether or not a patient responded to the treatment. Display the model output including confidence intervals. *You will need to make `Resp` a factor before fitting the model.*
