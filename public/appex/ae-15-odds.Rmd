...
1. What is the probability a randomly selected person in the study has a **<u>not</u>** high risk of heart disease? 
...
2. Based on the model, if a randomly selected person has a total cholesterol of 225, 
  ...
  - what are the **odds** have a high risk of heart disease? 
  - what is the probability have a high risk of heart disease? Calculate the answer "manually" using the odds or log-odds. 
...
2. Based on your previous answer, how might you interpret the coefficient of `totlChol` in terms of the **log-odds**?
