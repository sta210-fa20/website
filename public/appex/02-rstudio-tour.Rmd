...
- Go to the course GitHub organization: https://github.com/sta210-fa20. 
...
- Go to the [course organization](https://github.com/sta210-fa20) on GitHub  and find the repo with the prefix **ae-02-**. 
...
- Open the RMarkdown file **ae-02-ads.Rmd**. We will use that for the next part of class. 
...
Follow along with the instructions in **ae-02-ads.Rmd**. An html version of the file can be found [here](https://sta210-fa20.netlify.app/appex/ae-02-ads.html).
